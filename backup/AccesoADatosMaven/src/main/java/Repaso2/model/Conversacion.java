...
public class Conversacion {
	...
	public Conversacion(String pregunta, String respuesta, LocalDate fechaConversacion, double numValoracionesPositivas,
			TipoAgente tipo) {
		super();
		this.pregunta = pregunta;
		this.respuesta = respuesta;
	...
	public void setNumValoracionesPositivas(double numValoracionesPositivas) {
		this.numValoracionesPositivas = numValoracionesPositivas;
	}
